...
conf_mat$conf_data <- c(TP[[dc_ix]] * num_cartel_actual , FN[[dc_ix]]* num_cartel_actual, 
                        FP[[dc_ix]] * num_fair_actual , TN[[dc_ix]]*num_fair_actual)
...
plot_dist <- function(data, contract, category_name){
  ...
  geom_density(alpha = 0.6, show.legend = FALSE, trim = FALSE, adjust = 0.6) +
